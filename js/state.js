...
export const MODEL_LOGOS = {
    ...
    // Xiaomi
    'xiaomi': '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3h18v18H3V3zm2 2v14h14V5H5zm2 2h10v2H7V7zm0 4h10v2H7v-2zm0 4h6v2H7v-2z" fill="currentColor"/></svg>',

    // MiniMax
    'minimaxai': '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/><path d="M8 8h8v8H8z" fill="currentColor"/></svg>'
};
...
// Lagoon Uncensored core prompt - injected at index 0 when uncensored_mode is true
// This is the EXACT prompt from configs/Lagoon Uncensored.json - DO NOT MODIFY
export const LAGOON_UNCENSORED_CORE = `What you are: A local, open weight model SF-Tuned for uncensored interaction.
