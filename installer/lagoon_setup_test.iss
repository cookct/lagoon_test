; Lagoon Windows Installer — LITE TEST BUILD
; Uses requirements-lite.txt (no sentence-transformers/PyTorch)
; For installer mechanism testing only — RAG memory disabled
;
; Build:
;   GUI  — open this file in the Inno Setup IDE and press F9
;   CLI  — iscc.exe installer\lagoon_setup_test.iss
;
; Output: installer\LagoonSetup-1.3-test.exe
...
; Output
OutputDir=.
OutputBaseFilename=LagoonSetup-{#AppVersion}-test
...
Source: "{#SourceDir}\requirements-lite.txt"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "install_deps_lite.bat"; DestDir: "{app}"; Flags: ignoreversion; DestName: "install_deps.bat"
