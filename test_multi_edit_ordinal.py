...
tasks = [
    {"prompt": "show me the first image unaltered", "output": "lagoon_test/test/result_ord1.png"},
    {"prompt": "show me the second image unaltered", "output": "lagoon_test/test/result_ord2.png"}
]
...
for task in tasks:
    ...
    # Using a 60s timeout just in case
